...
public class LnpStatusReason implements java.io.Serializable {
    ...
    public LnpStatusReason(java.lang.String type, java.lang.String type_label, https.LnpStatusReasonDetail[] details) {
        this.type = type;
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "type_label"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
