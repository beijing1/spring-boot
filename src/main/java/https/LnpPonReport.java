...
public class LnpPonReport  implements java.io.Serializable {
    ...
    public LnpPonReport(
           ...
           https.LnpStatusReason status_reason,
           java.lang.String note,
           https.LnpRoutingStructure routing,
           https.LnpVerStructure[] versions) {
           this.date = date;
           this.pon = pon;
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LnpPonReport)) return false;
        ...
        _equals = true && 
            ...
            ((this.status_reason==null && other.getStatus_reason()==null) || 
             (this.status_reason!=null &&
              this.status_reason.equals(other.getStatus_reason()))) &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LnpPonReport.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "lnpPonReport"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "status_reason"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "lnpStatusReason"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("note");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "note"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "versions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "lnpVerStructure"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
