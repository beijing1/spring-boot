  ...
  private void _initEspressoDIDPortTypeProxy() {
    try {
      ...
      if (espressoDIDPortType != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)espressoDIDPortType)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)espressoDIDPortType)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
