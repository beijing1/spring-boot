...
public class EspressoDIDLocator extends org.apache.axis.client.Service implements https.EspressoDID {
    ...
    public EspressoDIDLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public https.EspressoDIDPortType getespressoDIDPort() throws javax.xml.rpc.ServiceException {
    ...
    public https.EspressoDIDPortType getespressoDIDPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            https.EspressoDIDBindingStub _stub = new https.EspressoDIDBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (https.EspressoDIDPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                https.EspressoDIDBindingStub _stub = new https.EspressoDIDBindingStub(new java.net.URL(espressoDIDPort_address), this);
                _stub.setPortName(getespressoDIDPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "espressoDID");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "espressoDIDPort"));
        }
