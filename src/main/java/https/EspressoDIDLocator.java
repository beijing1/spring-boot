...
public class EspressoDIDLocator extends org.apache.axis.client.Service implements https.EspressoDID {
    ...
    public https.EspressoDIDPortType getespressoDIDPort(java.net.URL portAddress)
            throws javax.xml.rpc.ServiceException {
        try {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (https.EspressoDIDPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                https.EspressoDIDBindingStub _stub = new https.EspressoDIDBindingStub(
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test",
                    "espressoDIDPort"));
        }
