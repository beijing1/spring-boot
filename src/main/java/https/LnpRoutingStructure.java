...
public class LnpRoutingStructure  implements java.io.Serializable {
    ...
    private https.LnpRoutingDetails[] details;

    public LnpRoutingStructure() {
    }

    public LnpRoutingStructure(
           int default_routing_profile,
           https.LnpRoutingDetails[] details) {
     ...
     * @return details
     */
    public https.LnpRoutingDetails[] getDetails() {
        return details;
    }
     ...
     * @param details
     */
    public void setDetails(https.LnpRoutingDetails[] details) {
        this.details = details;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LnpRoutingStructure)) return false;
        ...
        boolean _equals;
        _equals = true && 
            this.default_routing_profile == other.getDefault_routing_profile() &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LnpRoutingStructure.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "lnpRoutingStructure"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("default_routing_profile");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "default_routing_profile"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:https://connect.espressodid.com/cloud/public/v3/test", "lnpRoutingDetails"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
