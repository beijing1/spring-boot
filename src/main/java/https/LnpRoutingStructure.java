...
public class LnpRoutingStructure implements java.io.Serializable {
    ...
    public LnpRoutingStructure(int default_routing_profile, https.LnpRoutingDetails[] details) {
    ...
    static {
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "default_routing_profile"));
