...
public class CreatePonsRequestSqlProvider {
    ...
    public String insertSelective(CreatePonsRequest record) {
        ...
        if (record.getCreatedTs() != null) {
            sql.VALUES("\"CREATED_TS\"", "#{createdTs,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCreatedTs() != null) {
            sql.SET("\"CREATED_TS\" = #{record.createdTs,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(CreatePonsRequest record) {
        ...
        if (record.getCreatedTs() != null) {
            sql.SET("\"CREATED_TS\" = #{createdTs,jdbcType=TIMESTAMP}");
        }
