...
public class LnpVerStructure implements java.io.Serializable {
    ...
    private com.espressodid.connect.cloud._public.v3.test.LnpVerStructureHistory[] history;

    public LnpVerStructure() {
    }

    public LnpVerStructure(java.lang.String version,
            com.espressodid.connect.cloud._public.v3.test.LnpVerStructureHistory[] history) {
     ...
     * @return history
     */
    public com.espressodid.connect.cloud._public.v3.test.LnpVerStructureHistory[] getHistory() {
        return history;
    }
     ...
     * @param history
     */
    public void setHistory(com.espressodid.connect.cloud._public.v3.test.LnpVerStructureHistory[] history) {
        this.history = history;
    }
    ...
    static {
        ...
        elemField.setXmlName(
                new javax.xml.namespace.QName("https://connect.espressodid.com/cloud/public/v3/test", "version"));
        ...
        elemField.setXmlName(
                new javax.xml.namespace.QName("https://connect.espressodid.com/cloud/public/v3/test", "history"));
