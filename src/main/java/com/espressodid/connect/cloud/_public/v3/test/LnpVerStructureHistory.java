...
public class LnpVerStructureHistory implements java.io.Serializable {
    ...
    private com.espressodid.connect.cloud._public.v3.test.LnpStatusStructure[] status;

    public LnpVerStructureHistory() {
    }

    public LnpVerStructureHistory(java.lang.String date,
            com.espressodid.connect.cloud._public.v3.test.LnpPonStructure pon_data,
            com.espressodid.connect.cloud._public.v3.test.LnpStatusStructure[] status) {
        this.date = date;
     ...
     * @return status
     */
    public com.espressodid.connect.cloud._public.v3.test.LnpStatusStructure[] getStatus() {
        return status;
    }
     ...
     * @param status
     */
    public void setStatus(com.espressodid.connect.cloud._public.v3.test.LnpStatusStructure[] status) {
        this.status = status;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LnpVerStructureHistory))
            return false;
        ...
        _equals = true
                ...
                && ((this.status == null && other.getStatus() == null)
                        || (this.status != null && java.util.Arrays.equals(this.status, other.getStatus())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            LnpVerStructureHistory.class, true);
