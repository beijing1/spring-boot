...
public class ErrorsField implements java.io.Serializable {
    ...
    private java.lang.String array_key;
     ...
     * @return array_key
     */
    public java.lang.String getArray_key() {
        return array_key;
    }
     ...
     * @param array_key
     */
    public void setArray_key(java.lang.String array_key) {
        this.array_key = array_key;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getArray_key() != null) {
            _hashCode += getArray_key().hashCode();
        }
    ...
    static {
        typeDesc.setXmlType(
                new javax.xml.namespace.QName("https://connect.espressodid.com/cloud/public/v3/test", "errorsField"));
        ...
        elemField.setXmlName(
                new javax.xml.namespace.QName("https://connect.espressodid.com/cloud/public/v3/test", "array_key"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
