...
public class LnpStatusReason implements java.io.Serializable {
    ...
    private com.espressodid.connect.cloud._public.v3.test.LnpStatusReasonDetail[] details;

    public LnpStatusReason() {
    }

    public LnpStatusReason(java.lang.String type, java.lang.String type_label,
            com.espressodid.connect.cloud._public.v3.test.LnpStatusReasonDetail[] details) {
        this.type = type;
     ...
     * @return details
     */
    public com.espressodid.connect.cloud._public.v3.test.LnpStatusReasonDetail[] getDetails() {
        return details;
    }
     ...
     * @param details
     */
    public void setDetails(com.espressodid.connect.cloud._public.v3.test.LnpStatusReasonDetail[] details) {
        this.details = details;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LnpStatusReason))
            return false;
        ...
        _equals = true
                ...
                && ((this.type_label == null && other.getType_label() == null)
                        || (this.type_label != null && this.type_label.equals(other.getType_label())))
    ...
    static {
        ...
        elemField.setXmlName(
                new javax.xml.namespace.QName("https://connect.espressodid.com/cloud/public/v3/test", "type"));
        ...
        elemField.setXmlName(
                new javax.xml.namespace.QName("https://connect.espressodid.com/cloud/public/v3/test", "type_label"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
